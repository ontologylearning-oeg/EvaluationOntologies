...
<div id="contenido" class="container section">
    ...
    <div class="row">
        ...
        <div class="col s3 offset-s1 card-panel teal" style="background-color: rgba(248, 187, 134, 0.2)!important">
            ...
            <p class="card-title center-align">Distinct evaluators</p>
        </div>
    </div>
    <div class="row">
        <div class="col s3 offset-s2 card-panel teal" style="background-color: rgba(248, 187, 134, 0.2)!important">
            <p class="center-align"><c:out value="${sessionScope.admin.complete}"/></p>
            <p class="card-title center-align">Percentage of complete</p>
        </div>
        <div class="col s3 offset-s2 card-panel teal" style="background-color: rgba(248, 187, 134, 0.2)!important">
