        ...
        <div class="card-panel blue lighten-1">
            ...
            <ul class="collection">
                <c:forEach var="ontology" items="${applicationScope.ontos}">
                    <li class="collection-item"><div>${ontology.name} (Domain of ${ontology.domain})<a onclick="loadOntology('${ontology.name}');" class="secondary-content"><i class="material-icons">send</i></a></div></li>
                </c:forEach>
            </ul>
        </div>
    </div>
